 ...
 * @author RojeruSan
 */
public class ErrorAlerts extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public ErrorAlerts(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            getLogger(ErrorAlerts.class.getName()).log(SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        invokeLater(() -> {
            ErrorAlerts dialog = new ErrorAlerts(new javax.swing.JFrame(), true);
    ...
    private static final Logger LOG = getLogger(ErrorAlerts.class.getName());
}
