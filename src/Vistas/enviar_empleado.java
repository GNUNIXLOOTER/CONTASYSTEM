...
public class enviar_empleado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        checkApellido.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void tabla1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla1MouseClicked
        ...
        if(txt_recibeEmpleado.getText().equals("50")){
            Factura_Nota_Credito_Venta.comboVendedor.setSelectedItem(nombres+" "+apellidos);
            Factura_Nota_Credito_Venta.txtCodigoEmpleado.setText(cedula);
            this.setVisible(false);
        }else{
        if(txt_recibeEmpleado.getText().equals("1")){
            Factura_Venta.comboVendedor.setSelectedItem(nombres+" "+apellidos);
                ...
                if(txt_recibeEmpleado.getText().equals("14")){
                    ...
                    if(txt_recibeEmpleado.getText().equals("15")){
                        ...
                        if(txt_recibeEmpleado.getText().equals("16")){
                            Caja_Cierre.comboVendedor.setSelectedItem(nombres+" "+apellidos);
                            Caja_Cierre.txtCodVendedor.setText(cedula);
                            this.setVisible(false);
                        }else{
                        ...
                        if(txt_recibeEmpleado.getText().equals("17")){
                            Caja_Ingreso.comboVendedor.setSelectedItem(nombres+" "+apellidos);
                            Caja_Ingreso.txtCodVendedor.setText(cedula);
                            this.setVisible(false);
                        }
                           else{
                        if(txt_recibeEmpleado.getText().equals("2")){
                            Factura_Nota_Credito_Compra.comboVendedor.setSelectedItem(nombres+" "+apellidos);
                            //Factura_Nota_Credito_Compra.txtCodVendedor.setText(cedula);
                            this.setVisible(false);
                        }
                            }
                                }
