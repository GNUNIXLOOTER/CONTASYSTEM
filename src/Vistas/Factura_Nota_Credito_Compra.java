...
public class Factura_Nota_Credito_Compra extends javax.swing.JFrame {
    ...
    Factura_Nota_Credito_Compra(Principal aThis, boolean b) {
    ...
    private void initComponents() {
        ...
        buscarArticulo.setBackground(new java.awt.Color(47, 172, 148));
        ...
        jPanel1.add(btnGuardarNota, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 370, 180, 160));
        ...
        btnCancelarNota.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jPanel1.add(btnCancelarNota, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 370, 170, 160));

        jLabel19.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 255, 255));
        jLabel19.setText("Cancelar");
        jPanel1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 480, 90, 40));

        jLabel17.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("Facturar");
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 480, -1, 40));
        ...
        txtNroFactura.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        buscarFactura.setBackground(new java.awt.Color(47, 172, 148));
        buscarFactura.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/iconoLupaF3.png"))); // NOI18N
        buscarFactura.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        buscarVendedor.setBackground(new java.awt.Color(47, 172, 148));
    ...
    private void buscarVendedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarVendedorActionPerformed
        ...
        form.toFront();
        enviar_empleado.txt_recibeEmpleado.setText("2");
                                   ...
                                   JOptionPane.showMessageDialog(null, "Las notas de credito de tipo A solo se pueden realizar a otros Responsables Inscriptos","Advertencia",JOptionPane.WARNING_MESSAGE);
                                    ...
                                    if (comboFactura.getSelectedItem().equals("FACTURA B") && comboContribuyente.getSelectedItem().equals("Responsable Inscripto")) {
                                       ...
                                       JOptionPane.showMessageDialog(null, "Las notas de credito de tipo B solo se pueden realizar a Responsables Monotributo o Consumidores finales","Advertencia",JOptionPane.WARNING_MESSAGE);
                                        ...
                                        if (txtCuit.getText().length()!=10 && !comboContribuyente.getSelectedItem().equals("Consumidor Final")) {
                                               banderaFactura=1;
                                               JOptionPane.showMessageDialog(null, "El campo CUIT debe contener 10 digitos","Advertencia",JOptionPane.WARNING_MESSAGE);
