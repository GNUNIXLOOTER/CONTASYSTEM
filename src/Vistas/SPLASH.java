...
public class SPLASH extends javax.swing.JDialog implements Runnable{
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/CARGARTUERCA.gif"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SPLASH splash = new SPLASH(new javax.swing.JFrame(), true);
