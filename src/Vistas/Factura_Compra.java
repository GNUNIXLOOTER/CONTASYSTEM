...
public class Factura_Compra extends javax.swing.JFrame {
    ...
    String NOMBRE;
    String dia, mes, año;
    private final String logotipo="/img/X.jpg";
    ...
    Factura_Compra(Principal aThis, boolean b) {
    ...
    private void initComponents() {
        ...
        comboArticulos.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        buscare2.setBackground(new java.awt.Color(47, 172, 148));
        buscare2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/iconoLupaF5.png"))); // NOI18N
        buscare2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        btn_guardarCompra.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jPanel1.add(btn_guardarCompra, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 400, 180, 160));
        ...
        jPanel1.add(btnCancelarCompra, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 400, 210, 160));

        jLabel19.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 255, 255));
        jLabel19.setText("Cancelar");
        jPanel1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 510, -1, -1));

        jLabel17.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("Facturar");
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 510, 110, -1));
        ...
        jPanel5.setBackground(new java.awt.Color(78, 184, 221));
        ...
        txtFacturaNumero.setForeground(new java.awt.Color(255, 255, 255));
        ...
        menuItemBuscarProveedor.setBackground(new java.awt.Color(78, 184, 221));
        menuItemBuscarProveedor.setFont(new java.awt.Font("Segoe UI", 0, 21)); // NOI18N
        menuItemBuscarProveedor.setForeground(new java.awt.Color(255, 255, 255));
        ...
        menuItemAgregarProveedor.setBackground(new java.awt.Color(78, 184, 221));
        menuItemAgregarProveedor.setFont(new java.awt.Font("Segoe UI", 0, 21)); // NOI18N
        menuItemAgregarProveedor.setForeground(new java.awt.Color(255, 255, 255));
        ...
        menuItemBuscarArticulo.setBackground(new java.awt.Color(78, 184, 221));
        menuItemBuscarArticulo.setFont(new java.awt.Font("Segoe UI", 0, 21)); // NOI18N
        menuItemBuscarArticulo.setForeground(new java.awt.Color(255, 255, 255));
        ...
        menuItemAgregarArticulo.setBackground(new java.awt.Color(78, 184, 221));
        menuItemAgregarArticulo.setFont(new java.awt.Font("Segoe UI", 0, 21)); // NOI18N
        menuItemAgregarArticulo.setForeground(new java.awt.Color(255, 255, 255));
                            ...
                            if (fact.getText().equals("")) {
                                ...
                                if (tabla.getRowCount() <= 0) {
                                    ...
                                    try {
                                        ...
                                        int op = JOptionPane.showConfirmDialog(null, "DESEA IMPRIMIR LA FACTURA", "SELECCIONE UNA OPCION", JOptionPane.YES_NO_OPTION);
                                        if (op == JOptionPane.YES_NO_OPTION) {
                                            ...
                                            ventanavisor.setModalExclusionType(Dialog.ModalExclusionType.APPLICATION_EXCLUDE);
                                            ...
                                            try
                                            {
                                                JDialog viewer = new JDialog(new javax.swing.JFrame(), "Reporte de Compra", true);
                                                viewer.setSize(1040, 701);
                                                viewer.setLocationRelativeTo(null);
                                               
                                                JasperReport relatoriosJasper
                                                        = (JasperReport) JRLoader.loadObject("compra.jasper");

                                                JasperPrint jasperPrint = JasperFillManager.fillReport(relatoriosJasper, parametros, miconexion);
